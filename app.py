...
@media (prefers-color-scheme: dark) {
    ...
    [data-testid="stSidebar"] {
        background: #211520 !important;
        border-right-color: #3a2535 !important;
    }
    .sidebar-brand { color: #e87aaa !important; }
    .sidebar-tagline { color: #9e7a8e !important; }
    [data-testid="stSidebar"] .stRadio div[role="radiogroup"] label {
        color: #d4bec9 !important;
    }
    [data-testid="stSidebar"] .stRadio div[role="radiogroup"] label:hover {
    ...
    .stButton > button:hover {
        background: #e87aaa !important;
        color: #1a1118 !important;
    }
    label[data-testid="stWidgetLabel"] p { color: #9e7a8e !important; }
    h2 { color: #f0e8ed !important; }
    h3 { color: #9e7a8e !important; }
    .stat .lbl { color: #9e7a8e !important; }
    hr { border-color: #3a2535 !important; }
}
:root[data-theme="dark"] [data-testid="stAppViewContainer"],
:root[data-theme="dark"] [data-testid="stAppViewContainer"] > .main {
    background: #1a1118 !important;
    color: #f0e8ed !important;
}
...
:root[data-theme="dark"] .sidebar-brand { color: #e87aaa !important; }
:root[data-theme="dark"] .sidebar-tagline { color: #9e7a8e !important; }
:root[data-theme="dark"] [data-testid="stSidebar"] .stRadio div[role="radiogroup"] label {
    color: #d4bec9 !important;
}
...
:root[data-theme="dark"] .stat .lbl { color: #9e7a8e !important; }
:root[data-theme="dark"] h2 { color: #f0e8ed !important; }
:root[data-theme="dark"] h3 { color: #9e7a8e !important; }
:root[data-theme="dark"] hr { border-color: #3a2535 !important; }
